...
**Current focus:** Authenticated identity actions: shared Settings deletion and Android native owner/system-PIN integration pass the eight-check actual journey, preserving three live napplet drafts. The iOS erase adapter also preserves durable failures with targeted regressions. Manual backup, physical iOS action proof and biometric/older-Android coverage remain next.
