...
Core installation, engineering docs, and quality/native CI were recorded during the initial scaffold setup.
...
signature verifies; no device was attached. Earlier CI evidence belongs to the initial scaffold, not the current package-manager migration.
