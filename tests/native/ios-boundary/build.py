...
def inputs():
 ...
 files += [REPO/'modules/napplet-host/ios'/n for n in ['RestrictedNappletHost.swift','NappletHostView.swift','NappletHostModule.swift','HypergolicNappletHost.podspec']]
