...
[identity implementation checkpoint](identity-storage.md). Identity management,
signing, saved data and published loading remain incomplete. The supplied logo
